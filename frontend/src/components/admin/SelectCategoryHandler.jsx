...
const SelectCategoryHandler = ({ categoryID, parentCategory, setParentCategory, defaultCategoryName, defaultCategoryID }) => {
    const { data: CategoryData, isSuccess: CategoryisSuccess, isLoading: CategoryisLoading } = useGetAllCategoryQuery()
