                ...
                <div class="hero-content">
                    ...
                    <div class="mt-4">
                        <form class="d-flex justify-content-center" role="search">
                            <input defaultValue={searchParams.get("keyword")} onChange={(e) => inputHandler(e)} class="form-control me-2 w-50" type="search" placeholder="Search here..." aria-label="Search" />
